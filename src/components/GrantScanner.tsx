...
// Performance: Extract GrantCard and wrap in React.memo.
// Impact: Prevents Virtual DOM diffing of all displayed grant cards when state changes
// (such as user typing in filter inputs or scanning state updates).
// Also memoizes expensive Date parsing and localized formatting.
