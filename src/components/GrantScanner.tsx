...
// Performance: Extract GrantCard as a memoized sub-component to prevent unnecessary re-renders
// during filter text input changes. Date formatting is also memoized per card.
// Impact: Eliminates expensive DOM re-diffing and Date parsing overhead when typing filter criteria.
