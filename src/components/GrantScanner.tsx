...
// Performance: Extract GrantCard and wrap in React.memo to prevent unnecessary re-renders of cards
// when typing into filter input fields or when parent state updates.
// Impact: Eliminates DOM diffing and redundant Date calculations for all rendered grant items on each keystroke.
