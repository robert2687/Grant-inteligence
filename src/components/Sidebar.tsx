...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  ...
  // Performance: Memoize navItems array using the stabilized translation function `t`.
  // This prevents recreating navigation objects on every render (e.g. sidebar collapse/expand, tab switches).
