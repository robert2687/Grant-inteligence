...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  ...
  // especially when toggling the sidebar open/closed or switching tabs.
  // Impact: Reduces overhead of creating an array of objects and looking up 7 translations on each render cycle.
