...
export default function ProjectManager() {
  ...
  // Performance: Memoize active project lookup to prevent redundant O(N) array searches on every render
  const activeProject = useMemo(() =>
    projects.find(p => p.id === activeProjectId) || null,
    [projects, activeProjectId]
  );

  // Performance: Use lazy initialization to avoid redundant object creation and randomUUID() calls on every render
  ...
  // Performance: Pass the full project object to avoid redundant O(N) search inside the handler
