...
export default function ProjectManager() {
  ...
  // Performance: Memoize active project lookup to avoid re-calculating on every render
  const activeProject = useMemo(() =>
    projects.find(p => p.id === activeProjectId) || null,
    [projects, activeProjectId]
  );

  // Performance: Use lazy initialization to prevent redundant object creation and UUID calls on every render
  ...
  // Performance: Accept the project object directly to avoid redundant O(N) lookup
