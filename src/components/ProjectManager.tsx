...
export default function ProjectManager() {
  ...
  // Performance: Memoize active project lookup to avoid O(n) searches on every render
  const activeProject = useMemo(() =>
    projects.find(p => p.id === activeProjectId) || null,
    [projects, activeProjectId]
  );

  // Performance: Use lazy initializer to prevent redundant object creation
  // and expensive crypto.randomUUID() calls on every render.
