...
export default function ProjectManager() {
  ...
  // Performance: Memoize active project lookup to avoid O(N) search on every render (e.g. typing)
  const activeProject = useMemo(() =>
    projects.find(p => p.id === activeProjectId) || null,
    [projects, activeProjectId]
  );

  // Performance: Use lazy initialization to prevent redundant object creation and UUID generation
  ...
  // Performance: Accept full project object to avoid redundant lookup
