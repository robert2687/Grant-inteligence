...
export default function ProjectManager() {
  ...
  // Performance: Memoize active project lookup to avoid re-calculating O(n) find on every render
  const activeProject = useMemo(() =>
    projects.find(p => p.id === activeProjectId) || null,
    [projects, activeProjectId]
  );

  // Performance: Use a lazy initializer for formData state to avoid redundant object creation
  // and expensive crypto.randomUUID() calls on every render cycle.
