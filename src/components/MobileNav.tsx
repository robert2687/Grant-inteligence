...
export default function MobileNav({ activeTab, setActiveTab }: MobileNavProps) {
  ...
  // Performance: Memoize navigation items to prevent redundant array/object instances on every render.
  // Depends on 't' to ensure labels update correctly when the language changes.
