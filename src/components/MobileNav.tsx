...
export default function MobileNav({ activeTab, setActiveTab }: MobileNavProps) {
  ...
  // Performance Optimization: Memoize navigation items to prevent redundant array and object recreation on every render.
  // Impact: Reduces overhead when the mobile navigation bar is re-rendered due to parent state changes.
