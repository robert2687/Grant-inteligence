...
export default function MobileNav({ activeTab, setActiveTab }: MobileNavProps) {
  ...
  // Performance: Memoize navigation items to prevent redundant object allocation and re-translation on every render.
  // This ensures referential stability of the navItems array across re-renders (e.g., when switching tabs).
  // Impact: Avoids re-creating the array and looking up 7 translations per render.
